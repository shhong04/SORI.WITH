...
- 참여형 시연 안내: `http://127.0.0.1:8000/web/demo-guide.html`
- **참여형 HUD (로컬 Mac)**  
  - 모니터: `http://127.0.0.1:8000/web/demo-monitor.html`  
  - 관객(폰/다른 탭): `http://127.0.0.1:8000/web/demo-audience.html`  
  - 파트 선택 → 모니터 하이라이트 · 녹음/WAV/샘플 업로드 → 모니터에서 분석 실행
